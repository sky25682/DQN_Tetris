...
class Figure:
    ...
    figures = [
            [[0, 4, 8, 12], [0, 1, 2, 3]],#|
            [[0,1,5,6], [1, 5, 4, 8], [4,5,1,2], [0,4,5,9]],#ㄹ
            [[0, 1, 4, 8], [0, 4, 5, 6], [1, 5, 9, 8], [4, 5, 6, 10]],#reverse ㄱ
            [[0, 1, 5, 9], [4, 5, 6, 8], [0, 4, 8, 9], [2, 4, 5, 6]],#ㄱ
            [[1, 4, 5, 6], [1, 4, 5, 9], [4, 5, 6, 9], [0, 4, 5, 8]],#ㅗ
            [[0, 1, 4, 5]],#ㅁ
            ]
            ...
            for j in range(4):
                if i * 4 + j in self.figure.image():
                    if i + self.figure.y > self.height - 1 or \
                        ...
                        return True # true이면 겹쳤다는 것 -> stop
        return False
    ...
    def get_next_state(self):
        ...
        for num_rotate in range(self.figure.len_rotate()):
            for x in range(10):
                ...
                state_prop[(x, num_rotate)] =  self.get_board() #()가 키이고 = 뒤에 있는게 값이다.
